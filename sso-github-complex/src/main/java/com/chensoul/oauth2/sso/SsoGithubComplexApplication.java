...
public class SsoGithubComplexApplication {

	@Value("${security.oauth2.resource.userInfoUri}")
	private String userInfoUri;

	public static void main(String[] args) {
		SpringApplication.run(SsoGithubComplexApplication.class, args);
	}
...
//	@Bean
//	public AuthoritiesExtractor authoritiesExtractor(UserInfoRestTemplateFactory templateFactory) {
...
//				System.err.println("template: " + templateFactory.getUserInfoRestTemplate());
//				System.err.println("MAP SIZE: " + map.size());
//				Object userInfo = templateFactory.getUserInfoRestTemplate().getForObject(userInfoUri, Object.class);
